...
public class DetalleTemp {
    ...
    private String getNroArticuloERP;

    public String getGetNroArticuloERP() {
        return getNroArticuloERP;
    }

    public void setGetNroArticuloERP(String getNroArticuloERP) {
        this.getNroArticuloERP = getNroArticuloERP;
    }
    ...
    private int cod_cli_temp;

    public int getCod_cli_temp() {
        return cod_cli_temp;
    }

    public void setCod_cli_temp(int cod_cli_temp) {
    ...
    public String toString() {
        return "{" +
                "id=" + id +
                ", getNroArticuloERP='" + getNroArticuloERP + '\'' +
                ", kCOO='" + kCOO + '\'' +
                ", dCTO='" + dCTO + '\'' +
                ", dOCO=" + dOCO +
                ", lNID=" + lNID +
